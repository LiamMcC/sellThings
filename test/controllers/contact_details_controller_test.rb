...
class ContactDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_detail" do
    assert_difference('ContactDetail.count') do
      post contact_details_url, params: { contact_detail: { email: @contact_detail.email, message: @contact_detail.message, name: @contact_detail.name } }
    end
  ...
  test "should update contact_detail" do
    patch contact_detail_url(@contact_detail), params: { contact_detail: { email: @contact_detail.email, message: @contact_detail.message, name: @contact_detail.name } }
